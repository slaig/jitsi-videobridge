                ...
                if (status == 0)
                {
                    ...
                    else
                    {
                        ...
                        try
                        {
                            ...
                            {
                                System.out.println(">>>" + responseIQ.getError().getCondition());
                                System.out.println(">>>" + responseIQ.getError().getMessage());
                                System.out.println(">>>" + responseIQ.getError().getCode());
                                System.out.println(">>>" + responseIQ.getError().getType());
